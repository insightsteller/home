...
st.markdown("This application is a strimlit dashboard that can be used to analyze motor vehicle Collision in NYC")
...
st.markdown("Vehicle Collisions betweemn %i:00 and %i:00" %(hour, (hour+1) % 24))
st.write(pdk.Deck(
